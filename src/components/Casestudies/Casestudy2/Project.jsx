...
import ExampleImage from "../../../assets/images2/project.jpg"; // Replace with your actual path
...
const Project = () => {
  ...
  return (
    <div className="flex flex-col items-center max-w-7xl mx-auto px-5 pt-10">
      {/* Image on Top */}
      <img
        src={imageSrc}
