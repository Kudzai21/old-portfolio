...
import Image1 from "../../../assets/images3/problem1.jpg"; // Replace with your actual path
import Image2 from "../../../assets/images3/problem2.jpg"; // Replace with your actual path
  ...
  return (
    <div className="flex flex-col items-center max-w-7xl mx-auto px-5">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start w-full pt-10 gap-5">
        {/* Heading */}
        <h1 className="text-5xl md:text-8xl lg:text-[10rem] font-medium sm:w-2/5 flex flex-wrap">
